...
void log_chat(e_log_chat_type type, int type_id, const char* src_charname, int src_accid, const char* map, int x, int y, const char* dst_charname, const char* message);
