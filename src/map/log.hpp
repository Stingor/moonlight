...
void log_chat( e_log_chat_type type, int32 type_id, const char* src_charname, int32 src_accid, const char* map, int32 x, int32 y, const char* dst_charname, const char* message );
